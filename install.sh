...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        echo -e "${green}Đã phát hiện phiên bản mới nhất của XrayR：${last_version}，đang chuẩn bị cài đặt...${plain}"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/chau020620/XrayR/main/XrayR.sh
